...
public class UpdateAccountServlet extends HttpServlet {
    ...
    private final String ERROR_PAGE = "updateErr";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (foundErr) {
                ...
                boolean result = dao.update(username, password, check);
                if (result) {
                    url = "search?"
                            + "&txtSearchValue=" + searchValue;
                }
            ...
            log("SQLException at update" + ex.getMessage());
        } catch (NamingException n) {
            log("NamingException at update" + n.getMessage());
        } finally {
